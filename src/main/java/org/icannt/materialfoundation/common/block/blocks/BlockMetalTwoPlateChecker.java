 ...
 */
public class BlockMetalTwoPlateChecker extends BlockVariantBase {
	
    private static final PropertyEnum<EnumMetalTwo> VARIANT = PropertyEnum.create("blocks", EnumMetalTwo.class);
    
    public BlockMetalTwoPlateChecker() {
        super(Material.ROCK, MapColor.GRAY, "metal_two_plate_checker");
    }
	...
	{
		for (EnumMetalTwo type : EnumMetalTwo.values()) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(VARIANT, EnumMetalTwo.values()[meta]);
    }
    ...
    public void initItemBlockModels() {
    	for (EnumMetalTwo variant : EnumMetalTwo.values()) {
