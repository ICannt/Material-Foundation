 ...
 */
public class BlockMetalThreePlateChecker extends BlockVariantBase {
	
    private static final PropertyEnum<EnumMetalThree> VARIANT = PropertyEnum.create("blocks", EnumMetalThree.class);
    
    public BlockMetalThreePlateChecker() {
        super(Material.ROCK, MapColor.GRAY, "metal_three_plate_checker");
    }
