 ...
 */
public class BlockMetalOnePlateChecker extends BlockVariantBase {
	
    private static final PropertyEnum<EnumMetalOne> VARIANT = PropertyEnum.create("blocks", EnumMetalOne.class);
    
    public BlockMetalOnePlateChecker() {
        super(Material.ROCK, MapColor.GRAY, "metal_one_plate_checker");
    }
