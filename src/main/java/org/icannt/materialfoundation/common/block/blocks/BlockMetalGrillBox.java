...
/**
 * Created by ICannt on 04/03/17.
 */
public class BlockMetalGrillBox extends BlockGlassVariantBase {

	private static final PropertyEnum<EnumMetalGrillType> VARIANT = PropertyEnum.create("grill", EnumMetalGrillType.class);
   
    public BlockMetalGrillBox() {
        super(Material.IRON, false, "metal_grill_box");
    }
    ...
    public void initClient() {
        ModelLoader.setCustomMeshDefinition(Item.getItemFromBlock(this), stack -> {
            ...
            EnumMetalGrillType crate = EnumMetalGrillType.values()[meta];
            BlockRendererDispatcher dispatcher = Minecraft.getMinecraft().getBlockRendererDispatcher();
            Map<IBlockState, ModelResourceLocation> variants = dispatcher.getBlockModelShapes().getBlockStateMapper().getVariants(BlockMetalGrillBox.this);
            return variants.get(BlockMetalGrillBox.this.getDefaultState().withProperty(VARIANT, crate));
        });
    }
}
